...
# Hide these URLs from completion suggestions (still saved to history)
c.completion.web_history.exclude = ["*://grok.com/*?q=*"]
...
#   - ask: Prompt when requested (grants 'access-paste' permission).
config.set(
    "content.javascript.clipboard", "access-paste", "https://dash.cloudflare.com"
)
...
#   - ask: Prompt when requested (grants 'access-paste' permission).
config.set(
    "content.javascript.clipboard", "access-paste", "https://console.anthropic.com"
)
...
config.set(
    ...
    True,
    "file:///Users/mattias/Library/Application%20Support/qutebrowser/userscripts/*",
)
...
config.bind(
    ",p",
    f"open -t https://docs.google.com/spreadsheets/d/{os.environ.get('SHEET_ID_ATTENDANCE', '')}/edit?gid=1001726503#gid=1001726503",
)
...
config.bind(
    "sdo",
    "spawn --userscript script-runner.py /Users/mattias/.qutebrowser/metascripts/ ois-login",
)
