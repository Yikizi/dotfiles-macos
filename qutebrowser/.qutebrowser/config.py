...
#   - access-paste: Allow accessing the clipboard and pasting clipboard content.
#   - ask: Prompt when requested (grants 'access-paste' permission).
config.set('content.javascript.clipboard', 'access-paste', 'https://console.anthropic.com')
...
#   - access-paste: Allow accessing the clipboard and pasting clipboard content.
#   - ask: Prompt when requested (grants 'access-paste' permission).
config.set('content.javascript.clipboard', 'access-paste', 'https://vnc.tryhackme.tech')
...
# Type: List of Regex
c.hints.next_regexes = ['\\bNext\\b', '\\bnext\\b', '\\bmore\\b', '\\bnewer\\b', '\\b[>→≫]\\b', '\\b(>>|»)\\b', '\\bcontinue\\b']
...
config.bind(',e', 'open https://moodle.taltech.ee/auth/oidc/?source=loginpage')
config.bind(',f', 'open -t https://kapp.paugupill.ee/static/index.html')
config.bind(',g', 'open -t grok.com')
config.bind(',m', 'open -t https://monkeytype.com')
config.bind(',p', f'open -t https://docs.google.com/spreadsheets/d/{os.environ.get("SHEET_ID_ATTENDANCE", "")}/edit?gid=1001726503#gid=1001726503')
config.bind(',r', 'open -t https://grok.com')
config.bind(',t', 'open -t https://terminaltrove.com/new')
config.bind('<Meta+0>', 'tab-focus -2')
...
config.bind('<Meta+Shift+[>', 'tab-focus stack-prev')
config.bind('<Meta+Shift+]>', 'tab-focus stack-next')
...
config.bind('emc', 'open -t calendar.google.com')
config.bind('ep', 'mode-enter passthrough')
config.bind('etp', 'mode-enter passthrough')
config.bind('gc', 'tab-clone')
config.bind('m-t', 'open -t')
